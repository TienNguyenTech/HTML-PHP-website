					...
					<div class="row">
						<div class="col-lg-12 col-sm-12 text-center">
							<div class="main-menu-wrap">
								...
								<div class="site-logo">
									<a href="index.html">
										<img src="assets/img/logo.png" alt="Fruitkha Logo">
									</a>
								</div>
								<!-- logo -->
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6">
							<div class="footer-box subscribe">
								...
								<p>Subscribe to our mailing list to get the latest
									Subscribe to our mailing list to get the latest updates.</p>
